...
apps/
  ...
  web/      Next.js frontend (in production)
            content/legal/ holds the reviewed legal pages the build renders
...
change. The full phased product plan is tracked in `docs/roadmap.md`. The MSc
thesis, business and design material that used to live here is maintained in a
private repository.
