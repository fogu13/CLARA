...
Where to find them: LinkedIn, communities (Demand Curve, CX Accelerator, r/marketing, r/analytics),
your own network + referrals from each interviewee.

> Replace `[Name]`, `[Company]`, `[your form URL]`, `[scheduling link]` before sending.
> Personalize the **first line** of every message; it roughly doubles reply rates.

---

## Part A: Outreach messages

### A1. LinkedIn connection note (≤300 chars)
> Hi [Name], I'm doing MSc research on how teams turn customer feedback into action (and where it
> stalls). Would value ~20 min of your real experience. No pitch, and I'll share what I find. Mind if
> I connect?

### A2. LinkedIn DM / InMail (after connecting)
> Thanks for connecting, [Name]. Quick context: for my MSc in Responsible AI I'm researching how
> marketing/product/CX teams *actually* act on customer feedback: what works, what stalls, and whether
...
### A3. Email
**Subject options:** "20 min for MSc research on customer feedback?" · "How does [Company] act on customer feedback?" · "Quick research favour (no pitch)"
> Hi [Name],
>
> I'm an MSc (Responsible AI) student researching how teams turn customer feedback into action, and
...
### A4. Referral ask (to your own network)
> Quick favour: I'm interviewing marketers / product / CX folks at ~10–300-person companies for my MSc
> on customer-feedback workflows. Know anyone who'd give me 20 candid minutes (or do a 5-min survey)?
> A one-line intro would mean a lot, and I'm happy to share the findings with you too.
...
OPIT permits a small incentive (e.g., a coffee voucher) and the findings summary as a thank-you.

---

## Part B: Participant information & consent (DRAFT)

> **Check with your OPIT supervisor first**; there may be a required ethics template/consent form.
> This draft is GDPR-aware and fits the Responsible-AI framing.
...
**What it involves.** A voluntary ~20–30 minute online interview about how you handle customer feedback
...
criticism is more valuable to the research than praise, so please do not spare it. This dual role is
...
**Data & privacy.** Responses are **anonymized**: no names, employer, or identifying details appear in
the thesis. Any quotes used are anonymized. Data is stored securely, used only for this academic
research, and retained until [e.g. thesis completion + 6 months], then deleted. Lawful basis: your
consent. You may request access to or deletion of your data at any time via the email above.

**Consent (please confirm):**
...
*(For the async webform, the equivalent consent checkbox is already built into `interview-form.html`.)*
