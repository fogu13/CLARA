...
| H4 | Journey stage materially shapes prioritisation | RQ4 | Interviews; journey stage scored under a supplied closed inventory *(§5A.4.1: an upper bound, not the production condition)* |
| H5 | Routing to the right owner is a recurring failure point | RQ1, RQ4 | Interviews; owner scored under the same supplied inventory *(§5A.4.1: clears its floor, but not autonomous-routing accuracy)* |
...
| Lieferando | Food delivery | 82 | DE / EN | theme, journey stage, owner, action, risk, response pattern |
