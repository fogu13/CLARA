...
Despite academic skepticism, NPS achieved widespread industry adoption. De Haan, Verhoef, and Wiesel (2015) offered a more nuanced perspective in *International Journal of Research in Marketing*, showing that the predictive validity of NPS varies by industry and that its value lies partly in its organisational simplicity as a rallying metric. Morgan and Rego (2006) in *Marketing Science* similarly found that while NPS correlates with business performance, it does not consistently outperform alternative metrics like customer satisfaction or repurchase likelihood.

The consensus this debate settles on is multi-metric: NPS is defensible as one signal among several and indefensible as a singular one, which is the recommendation Keiningham, Aksoy, Buoye, and Cooil (2011) make for customer health assessment in *Journal of Service Management*.
