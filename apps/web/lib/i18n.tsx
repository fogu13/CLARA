...
const en = {
  ...
  integrations: {
    ...
    descAppStore: "Listen to your app's public App Store reviews (Apple's official feed — no scraping)",
  ...
  complianceProse: {
    ...
    residency3: "Inference endpoint is configurable per deployment — EU-hosted or on-premise; visible in the model card.",
...
const de: Dict = {
  ...
  integrations: {
    ...
    descAppStore: "Öffentliche App-Store-Bewertungen Ihrer App anhören (offizieller Apple-Feed — kein Scraping)",
  ...
  complianceProse: {
    ...
    residency3: "Der Inferenz-Endpunkt ist pro Deployment konfigurierbar — EU-gehostet oder on-premise; sichtbar in der Modellkarte.",
