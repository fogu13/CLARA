...
const en = {
  ...
  taxonomy: {
    ...
    bootstrapProposed: "Proposed {n} theme(s) from {scanned} signals. Review below.",
    bootstrapNoThemes: "Scanned {scanned} signals. No new themes above the confidence threshold.",
    hygienePassed: "Hygiene check passed. No duplicates, stale proposals or drifted categories.",
    apiUnreachableSample: "API unreachable. Showing sample data.",
    catalogs: "Catalogs",
  ...
  complianceProse: {
    ...
    residency5: "Governed listening: public sources (App Store feed, Trustpilot Business API, Play Developer API) are ingested only via official, owner-authorized channels — never scraped — with reviewer names pseudonymized at ingestion (legitimate interest, Art. 6(1)(f)).",
...
const de: Dict = {
  ...
  taxonomy: {
    ...
    bootstrapProposed: "{n} Thema/Themen aus {scanned} Signalen vorgeschlagen. Unten prüfen.",
    bootstrapNoThemes: "{scanned} Signale geprüft. Keine neuen Themen über der Konfidenzschwelle.",
    hygienePassed: "Hygieneprüfung bestanden. Keine Duplikate, veralteten Vorschläge oder abgedrifteten Kategorien.",
    apiUnreachableSample: "API nicht erreichbar. Beispieldaten werden angezeigt.",
    catalogs: "Kataloge",
  ...
  complianceProse: {
    ...
    residency5: "Governed Listening: öffentliche Quellen (App-Store-Feed, Trustpilot Business API, Play Developer API) werden ausschließlich über offizielle, autorisierte Kanäle eingelesen, niemals gescrapt, mit pseudonymisierten Verfassernamen ab Ingestion (berechtigtes Interesse, Art. 6 Abs. 1 lit. f).",
